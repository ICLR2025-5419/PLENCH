...
if __name__ == "__main__":
    ...
    # train_loader = InfiniteDataLoader(dataset=train_dataset, weights=None, batch_size=hparams['batch_size'])
    # val_loader = FastDataLoader(dataset=val_dataset, batch_size=64)
    # test_loader = FastDataLoader(dataset=test_dataset, batch_size=64)
    ...
    for step in range(start_step, n_steps):
        ...
        if (step % checkpoint_freq == 0) or (step == n_steps - 1):
            ...
            if args.dataset != 'FGNET':    
                ...
                acc = misc.topk_accuracy(algorithm, test_loader, device, topk=5)
